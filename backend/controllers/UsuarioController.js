...
const loginUsuario = async(req, res)=> {
    ...
    try {
        ...
        res.status(200).json({message: 'Autenticação realizada com sucesso', token}) //preciso disso aqui
...
const UsuarioController = {registraUsuario, loginUsuario, getUsuarioPorId, getUsuarioPorLogin}
